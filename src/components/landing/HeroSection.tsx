  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className={`relative z-10 h-full flex flex-col items-center justify-center text-center px-6 transition-all duration-1000 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        ...
        <a href="https://to.wendiro.com/5J6D/2J1A0/" target="_blank" rel="noopener noreferrer" className="clip-chamfer-lg bg-accent px-10 py-5 font-display text-sm md:text-base tracking-wider uppercase text-accent-foreground box-glow-orange hover:brightness-110 transition-all mb-4">
          ⬇ Play Free on PC
        </a>
